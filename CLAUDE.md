...
- **CRITICAL**: do not **EVER** run `git` commands
...
**CRITICAL**: required before yielding control: `pnpm lint && pnpm typecheck && pnpm test`

- This is **THE ONLY** command you are to run before yielding control (unless **EXPLICITLY** told otherwise) since it checks **EVERYTHING**
